...
declare module 'hkvideo-player' {
    ...
    export interface IPlayerOptions {
        ...
        ignores?: Array<'cssFullscreen' | 'danmu' | 'enter'  | 'download' | 'errorRetry' | 'time' | 'localPreview' | 'logger' | 'memoryPlay' | 'pip' | 'playNext' | 'reload' | 'rotate' | 'screenShot' | 'definition' | 'error' | 'fullscreen' | 'i18n' | 'loading' | 'mobile' | 'pc' | 'play' | 'playbackRate' | 'poster' | 'progress' | 'replay' | 'start' | 'videopip' | 'volume'>;
